import { getCurrentInstance, ref, unref, computed, watch as watch$1, nextTick as nextTick$1, isRef as isRef$1, defineComponent, resolveComponent, resolveDirective, openBlock, createBlock, withCtx, createVNode as createVNode$1, Fragment as Fragment$1, renderList, createTextVNode as createTextVNode$1, toDisplayString, withDirectives, onBeforeMount, onMounted, onUpdated, onUnmounted, h, watchEffect, renderSlot, createCommentVNode, vShow } from 'vue';
...
function useTree(watcherData) {
    ...
    watch$1(() => normalizedData.value, updateTreeData);
    watch$1(() => normalizedLazyNode.value, updateTreeData);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_el_popper, {
      ...
      (_ctx.multiple)
        ? (openBlock(), createBlock("div", _hoisted_1, [
            createVNode$1("div", _hoisted_2, [
              createVNode$1(_component_el_scrollbar, { "wrap-class": "el-table-filter__wrap" }, {
                default: withCtx(() => [
                  createVNode$1(_component_el_checkbox_group, {
                    ...
                    default: withCtx(() => [
                      (openBlock(true), createBlock(Fragment$1, null, renderList(_ctx.filters, (filter) => {
                        return (openBlock(), createBlock(_component_el_checkbox, {
                          key: filter.value,
                          label: filter.value
                        }, {
                          default: withCtx(() => [
                            createTextVNode$1(toDisplayString(filter.text), 1 /* TEXT */)
                          ]),
                          _: 2 /* DYNAMIC */
    ...
    trigger: withCtx(() => [
      withDirectives(createVNode$1("span", {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode$1("div", _hoisted_1$1, [
    ...
    createVNode$1("div", {
      ...
      (!_ctx.data || _ctx.data.length === 0)
        ? (openBlock(), createBlock("div", {
            ...
            createVNode$1("span", _hoisted_3$1, [
              renderSlot(_ctx.$slots, "empty", {}, () => [
                createTextVNode$1(toDisplayString(_ctx.emptyText || _ctx.t('el.table.emptyText')), 1 /* TEXT */)
              ])
            ])
          ], 4 /* STYLE */))
        : createCommentVNode("v-if", true),
    ...
    (_ctx.store.states.rightFixedColumns.value.length > 0)
      ...
      : createCommentVNode("v-if", true),
    withDirectives(createVNode$1("div", _hoisted_10, null, 512 /* NEED_PATCH */), [
