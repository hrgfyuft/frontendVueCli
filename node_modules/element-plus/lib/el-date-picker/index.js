...
var DatePicker = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const refProps = Object.assign(Object.assign({}, props), { focus: () => {
                var _a;
        ...
        return () => {
            var _a;
            const format = (_a = props.format) !== null && _a !== void 0 ? _a : (timePicker.DEFAULT_FORMATS_DATEPICKER[props.type] || timePicker.DEFAULT_FORMATS_DATE);
            return vue.h(timePicker.CommonPicker, Object.assign(Object.assign({}, props), { format, type: props.type, ref: commonPicker, 'onUpdate:modelValue': value => ctx.emit('update:modelValue', value) }), {
