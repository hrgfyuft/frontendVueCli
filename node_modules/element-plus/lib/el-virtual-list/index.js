...
const DefaultGridProps = {
    ...
    height: Object.assign(Object.assign({}, DefaultListProps.height), { validator: (val) => util.isNumber(val) }),
    ...
    return vue.defineComponent({
        ...
        setup(props, { emit, expose }) {
            ...
            const windowStyle = vue.computed(() => ([
                ...
                Object.assign({ direction: props.direction, height: util.isNumber(props.height) ? `${props.height}px` : props.height, width: util.isNumber(props.width) ? `${props.width}px` : props.width }, props.style),
            ]));
            const innerStyle = vue.computed(() => {
                ...
                return {
                    ...
                    pointerEvents: util.$(states).isScrolling ? 'none' : undefined,
            ...
            const scrollTo = (offset) => {
                ...
                states.value = Object.assign(Object.assign({}, util.$(states)), { scrollOffset: offset, scrollDir: getScrollDir(util.$(states).scrollOffset, offset), updateRequested: true });
                vue.nextTick(resetIsScrolling);
            };
