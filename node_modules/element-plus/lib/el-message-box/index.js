    ...
    setup(props, { emit }) {
        ...
        const handleAction = (action) => {
            ...
            if (state.beforeClose) {
                (_a = state.beforeClose) === null || _a === void 0 ? void 0 : _a.call(state, action, state, doClose);
            }
            else {
                doClose();
            }
        ...
        return Object.assign(Object.assign({}, vue.toRefs(state)), { visible,
            hasMessage,
            icon,
            ...
            vue.createVNode("div", _hoisted_9, [
              (_ctx.showCancelButton)
                ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                    ...
                    _: 1 /* STABLE */
                  }, 8 /* PROPS */, ["loading", "class", "round", "size"]))
                : vue.createCommentVNode("v-if", true),
              vue.withDirectives(vue.createVNode(_component_el_button, {
                ...
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["loading", "class", "round", "disabled", "size"]), [
