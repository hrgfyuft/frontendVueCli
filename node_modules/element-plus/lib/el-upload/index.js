...
var useHandlers = (props) => {
    ...
    vue.watch(() => props.fileList, (fileList) => {
        if (!isEqual__default['default'](cachedFiles, fileList)) {
            cachedFiles = [];
            uploadFiles.value = fileList.map(file => {
                const cloneFile = cloneDeep__default['default'](file);
                cachedFiles.push(cloneFile);
                return Object.assign(Object.assign({}, cloneFile), { uid: file.uid || genUid(tempIndex++), status: file.status || 'success' });
            });
        }
    }, {
        immediate: true,
...
var script$3 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const { abort, clearFiles, handleError, handleProgress, handleStart, handleSuccess, handleRemove, submit, uploadRef, uploadFiles, } = useHandlers(props);
